...
namespace ResxHere
{
    ...
    internal sealed class CreateResxHere
    {
        ...
        /// </summary>
        public static CreateResxHere Instance { get; private set; }
        ...
        private void MenuCommand_BeforeQueryStatus( object sender, EventArgs e )
        {
            ...
            if ( menuCommand != null )
            {
                ...
                var isCodeFile = transformFileInfo.Extension.EndsWith( ".cs", true, CultureInfo.InvariantCulture );
        ...
        private void AddResxFileForCulture( FileInfo file, CultureInfo culture )
        {
            ...
            try
            {
                ...
                FileNavigation.AddTemplateToFile( resxFile, file.FullName, "Resource", "CSharp", _Dte );
            }
            catch
            {
                //Ignore
